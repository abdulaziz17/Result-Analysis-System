...
<center>
<h3>IT Result Analysis System</h3>
</center>
 <?php
...
<table class="component"  border="3">
  <tr>
      <th align="center" colspan="8">OU Subject Wise Topper Results</th>
  </tr>
  <tr>
      <th>Subject : </th>
  ...
  <tr>
   ...
   <?php
        ...
        $sql="SELECT s.rno as rno ,section , name, credit,gp,gs
            FROM marks_info_it m,student_list s
            WHERE scode=$v4
                AND m.rno in (select rno from student_list where section in ('$v3') and sem=$v2)
            AND s.rno=m.rno
            ORDER BY gp desc,rno asc limit $v5"; 
