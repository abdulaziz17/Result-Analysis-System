...
<tr align="center">
    <td width="50%"><button class="button" ><a href="sumsubform.php">Subject Wise Summary </a></td>
    <td width="50%"><button class="button" ><a href="sumclassform.php">Class Wise Summary</a></td>
