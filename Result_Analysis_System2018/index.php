...
<link rel="shortcut icon" href="brain.ico"></link>
...
<tr align="center">
    <td width="50%"> <button class="button"> <a href="subjectform.php">Subject wise Result</a> </td>
    <td width="50%"><button class="button"> <a href="individualform.php"> Student Result</a></td>
</tr>
</table>
...
<table border="0" width="50%">
<tr align="center">
<td width="50%"><button class="button"> <a href="topperform.php">Toppers List</a><br></td>
<td width="50%"><button class="button"> <a href="summaryform.php">Summaries</a></td>
</tr>
