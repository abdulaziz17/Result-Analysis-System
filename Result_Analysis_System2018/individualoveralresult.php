...
onclick="window.print();return false;" /></form>        
  ...
  <tr>
      <th align="center" colspan="6">OU Individual Result </th>
  </tr>
  ...
  <tr>
      ...
      <?php echo "<td colspan=\"2\"align=\"center\">{$row["name"]}</td>"?>
       <?php endwhile;?>
      <th>Roll Number: </th>
      <td colspan="2" align="center"><?php echo htmlspecialchars($_POST["rno"]);?></td>
  </tr>
  ...
  <tr>
      <th>S.no</th>
        ...
        $sql="SELECT s.bitcode, s.sname , s.stype, m.credit, m.gp, m.gs
                FROM marks_info_it m,subjects s
                WHERE m.rno=$v3 and m.scode=s.scode order by stype desc"; 
